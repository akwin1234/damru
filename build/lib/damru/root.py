...
class RootOps:
    ...
    async def setup_memory_preload(self) -> None:
        ...
        # Write wrapper script that sets LD_PRELOAD before exec'ing real binary.
        # Zygote runs this wrapper â†’ loads libfakemem.so â†’ all forked Chrome
        # processes inherit the loaded library and its sysinfo() override.
        wrapper = (
            "#!/system/bin/sh\n"
        ...
        await self.adb.shell_root(f"echo '{b64}' | base64 -d > /system/bin/app_process64")
